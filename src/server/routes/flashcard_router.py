...
@router.get("/")
async def get_5_cards(exam_name:str,domain:str,subdomain:str=None,token:str = Depends(oauth2_scheme)):

    decode_access_token(token)

    return await get_5_flaschards_controller(exam_name,domain,subdomain)
