...
export function ProgressChart({ categoryBreakdown }: ProgressChartProps) {
  return (
    <div className="rounded-2xl border border-[hsl(var(--border-light))] bg-[hsl(var(--surface-elevated))] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-[hsl(var(--text-primary))]">Progress Trend</h3>
          <p className="mt-0.5 text-sm text-[hsl(var(--text-secondary))]">Your accuracy over time</p>
        </div>
      </div>
      <div className="h-72">
